...
public class AdminUserController {
    ...
    @GetMapping("/users")
    public ResponseEntity<ApiResponse<?>> getAllUsers(@PageableDefault(size = 10,page = 0) Pageable pageable) {
    ...
    public ResponseEntity<ApiResponse<?>> updateNickname(@PathVariable Long id,
