...
import org.example.pdnight.domain1.invite.service.InviteService;
...
import static org.example.pdnight.domain1.common.enums.ErrorCode.CANNOT_PARTICIPATE_POST;
...
public class ParticipantService {
    ...
    // ===========================================validate==========================================================
    // 참가자 목록 조회 용 검증 로직
    private void validateGetParticipantList(Post post, User user) {
