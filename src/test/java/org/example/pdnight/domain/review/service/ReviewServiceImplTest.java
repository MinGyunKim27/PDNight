...
class ReviewServiceImplTest {
    ...
    void 리뷰_등록_테스트_성공() {
        ...
        when(reviewJpaRepository.existsByReviewerAndRatedUserAndPost(reviewer, ratedUser, post)).thenReturn(false);
    ...
    void 자기자신_리뷰_예외() {
        ...
        BaseException exception = assertThrows(BaseException.class, () ->
                reviewServiceImpl.createReview(userId, userId, postId, mockRequestDto)
        );
    ...
    void 중복리뷰_예외() {
        ...
        when(reviewJpaRepository.existsByReviewerAndRatedUserAndPost(reviewer, ratedUser, post)).thenReturn(true);

        // when & then
        BaseException exception = assertThrows(BaseException.class, () ->
                reviewServiceImpl.createReview(1L, 2L, 1L, requestDto)
        );
