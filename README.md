...
![기술_DDD_도입배경_필요성.png](docs/image/%EA%B8%B0%EC%88%A0_DDD_%EB%8F%84%EC%9E%85%EB%B0%B0%EA%B2%BD_%ED%95%84%EC%9A%94%EC%84%B1.png)
...
![기술_Kafka_도입배경_필요성.png](docs/image/%EA%B8%B0%EC%88%A0_Kafka_%EB%8F%84%EC%9E%85%EB%B0%B0%EA%B2%BD_%ED%95%84%EC%9A%94%EC%84%B1.png)
...
![기술_Elasticsearch_도입배경_필요성.png](docs/image/%EA%B8%B0%EC%88%A0_Elasticsearch_%EB%8F%84%EC%9E%85%EB%B0%B0%EA%B2%BD_%ED%95%84%EC%9A%94%EC%84%B1.png)
...
|----------|---------|--------------------------------------------|-------------------------------------------|-------------------------------------------------|------------------------------------------------------------------------------------------------------------|
| **김민균**  | `👑팀장`  | `⭐뛰어난 지휘관`<br> `🎨아이디어 뱅크`<br> `🎤스피치 마스터` | [GitHub](https://github.com/MinGyunKim27) | [블로그]([https://velog.io/notifications](https://velog.io/@kmk27/posts))           | 📌 Kafka 시각화(모니터링)<br>📌 배포(CI/CD) <br> 📌 기술스택, 취미 기능 구현 <br>📌 유저 팔로우 구현                                 |
